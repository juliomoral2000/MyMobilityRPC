...
public class MobilityControllerRPCImpl extends MobilityControllerImpl {
    ...
    public MobilityControllerRPCImpl() {
    ...
    public MobilitySessionInternal getMessageHandlingSession(UUID sessionId) {
        ...
        // No session with the id was found. Create a new session with the same specified id...
        MobilitySessionInternal newSession = new MobilitySessionRPCImpl(sessionId, this);
    ...
    class MessageProcessorTask implements Runnable {
        ...
        public <T> void processMessage(ConnectionId connectionId, byte[] messageData) {
            try {
                ...
                deserializedMessageProcessor.process(MobilityControllerRPCImpl.this, connectionManager, connectionId, message);
            }
            catch (Exception e) {
